...
const DEMO_SCENARIOS: DemoScenario[] = [
  ...
  },
  {
    ...
    description: '31-year-old male presenting for annual wellness exam. History of low back pain and anxiety.',
    patientName: 'Dante Patterson',
