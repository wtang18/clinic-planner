 ...
 * Icon Component
 *
 * Cross-platform icon component using inlined SVG strings from the shared icon maps.
 * Uses react-native-svg's SvgXml for rendering in both native and web (Storybook).
 */

import React from 'react';
import { View, ViewStyle } from 'react-native';
import type { IconName } from '@design-system/icons/icon-names';
import { smallIconMap, mediumIconMap } from '@design-system/icons/icon-map.rn';
...
/**
 * Get SVG string for an icon from the icon maps
 */
 ...
 * Icon component
 *
 * Uses inlined SVG strings from the shared design-icons package.
 * Renders via react-native-svg's SvgXml (works in both native and web Storybook).
 *
 * Icon sizing:
 * - small: 20x20px - for compact UI elements
 * - medium: 24x24px - for standard UI elements
 *
 * @example
...
export const Icon = React.forwardRef<View, IconProps>(
  (
    ...
    const finalColor = color || colors.fg.neutral.primary;
