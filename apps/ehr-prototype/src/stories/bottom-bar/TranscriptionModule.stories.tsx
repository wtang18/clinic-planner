...
// ============================================================================
// TranscriptionBar Stories - All States
// ============================================================================
...
export const BarIdle: StoryObj = {
  name: 'Bar: Idle',
  render: () => <BarWrapper status="idle" />,
};

export const BarRecording: StoryObj = {
  name: 'Bar: Recording',
  render: () => <BarWrapper status="recording" duration={83} />,
};

export const BarPaused: StoryObj = {
  name: 'Bar: Paused',
  render: () => <BarWrapper status="paused" duration={272} />,
};

export const BarProcessing: StoryObj = {
  name: 'Bar: Processing',
  render: () => <BarWrapper status="processing" duration={180} />,
};

export const BarError: StoryObj = {
  name: 'Bar: Error',
  render: () => <BarWrapper status="error" error="Mic error" />,
};

export const BarComplete: StoryObj = {
  name: 'Bar: Complete',
  render: () => <BarWrapper status="complete" duration={180} />,
};

export const BarNoSession: StoryObj = {
  name: 'Bar: No Session',
  render: () => (
    <div style={{ padding: 32 }}>
      <TranscriptionBar
...
// ============================================================================
// TranscriptionBar - All States Grid
// ============================================================================

export const BarAllStates: StoryObj = {
  name: 'Bar: All States Overview',
  render: () => (
    <div style={{ padding: 32 }}>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
        {/* Idle */}
        <div>
          <p style={{ color: '#fff', marginBottom: 8, fontSize: 12, fontWeight: 600 }}>Idle</p>
          <p style={{ color: '#888', marginBottom: 12, fontSize: 11 }}>
            Avatar (no badge) + Name + Mic button
          </p>
          <BarWrapper status="idle" />
        </div>

        {/* Recording */}
        <div>
          <p style={{ color: '#fff', marginBottom: 8, fontSize: 12, fontWeight: 600 }}>Recording</p>
          <p style={{ color: '#888', marginBottom: 12, fontSize: 11 }}>
            Pulsing badge + Waveform/Timer + Pause
          </p>
          <BarWrapper status="recording" duration={83} />
        </div>

        {/* Paused */}
        <div>
          <p style={{ color: '#fff', marginBottom: 8, fontSize: 12, fontWeight: 600 }}>Paused</p>
          <p style={{ color: '#888', marginBottom: 12, fontSize: 11 }}>
            Pause badge + Waveform/Timer + Resume only
          </p>
          <BarWrapper status="paused" duration={272} />
        </div>

        {/* Processing */}
        <div>
          <p style={{ color: '#fff', marginBottom: 8, fontSize: 12, fontWeight: 600 }}>Processing</p>
          <p style={{ color: '#888', marginBottom: 12, fontSize: 11 }}>
            Spinner badge + "Processing..." + (empty)
          </p>
          <BarWrapper status="processing" duration={180} />
        </div>

        {/* Error */}
        <div>
          <p style={{ color: '#fff', marginBottom: 8, fontSize: 12, fontWeight: 600 }}>Error</p>
          <p style={{ color: '#888', marginBottom: 12, fontSize: 11 }}>
            Alert badge + Error text + Retry button
          </p>
          <BarWrapper status="error" error="Mic error" />
        </div>

        {/* Complete */}
        <div>
          <p style={{ color: '#fff', marginBottom: 8, fontSize: 12, fontWeight: 600 }}>Complete</p>
          <p style={{ color: '#888', marginBottom: 12, fontSize: 11 }}>
            Same as idle (ready for new recording)
          </p>
          <BarWrapper status="complete" duration={180} />
        </div>
      </div>
    </div>
  ),
...
export const BarPatientColors: StoryObj = {
  name: 'Bar: Patient Colors (Constant)',
  render: () => (
    <div style={{ padding: 32 }}>
      <p style={{ color: '#888', marginBottom: 16, fontSize: 12 }}>
        Avatar color is patient-assigned and stays constant across all states
      </p>
      <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
        <BarWrapper status="recording" duration={45} patientColor={PATIENT_COLORS.blue} />
        <BarWrapper status="recording" duration={83} patientColor={PATIENT_COLORS.teal} />
        <BarWrapper status="recording" duration={120} patientColor={PATIENT_COLORS.purple} />
        <BarWrapper status="recording" duration={272} patientColor={PATIENT_COLORS.green} />
      </div>
    </div>
  ),
};
...
// ============================================================================
// TranscriptionPalette Stories
// ============================================================================

const PaletteWrapper: React.FC<{ hasSegments?: boolean }> = ({ hasSegments = false }) => {
  ...
  return (
    <div style={{ width: 500, padding: 32 }}>
      <TranscriptionPalette
        session={session}
        onCollapse={() => console.log('Collapse')}
        onExpandToDrawer={() => console.log('Expand to drawer')}
        onStart={() => console.log('Start')}
        onPause={() => console.log('Pause')}
        onResume={() => console.log('Resume')}
        onStop={() => console.log('Stop')}
...
export const PaletteEmpty: StoryObj = {
  render: () => <PaletteWrapper hasSegments={false} />,
};

export const PaletteWithSegments: StoryObj = {
  render: () => <PaletteWrapper hasSegments />,
};
