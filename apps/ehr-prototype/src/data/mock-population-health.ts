 ...
 * cohort groups, protocols with node graphs, patients, metrics, and alerts.
 */
...
export const PROTOCOLS: Protocol[] = [
  // --- Diabetes A1c Protocol (7 columns, ~15 patients) ---
  {
    id: 'proto-diabetes-a1c',
    ...
    nodes: [
      { id: 'da-1', type: 'cohort-source', label: 'Diabetes Cohort', columnIndex: 0, verticalPosition: 0, pills: [{ label: '15 pts' }], config: {}, patientCount: 15 },
      { id: 'da-2', type: 'filter', label: 'A1c Due', description: 'Last A1c > 90 days ago', columnIndex: 1, verticalPosition: 0, pills: [{ label: '9 pts' }], config: { field: 'last_a1c_date', threshold: 90 }, patientCount: 9 },
      { id: 'da-3', type: 'action', label: 'Order A1c Lab', columnIndex: 2, verticalPosition: 0, pills: [{ label: '5 pending' }], config: { orderType: 'lab', code: '83036' }, patientCount: 5 },
      { id: 'da-4', type: 'wait-monitor', label: 'Await Results', description: 'Monitor for lab completion', columnIndex: 3, verticalPosition: 0, pills: [{ label: '3 waiting', variant: 'info' }], config: { waitDays: 14 }, patientCount: 3 },
      { id: 'da-5', type: 'branch', label: 'A1c Result', description: 'Route based on A1c value', columnIndex: 4, verticalPosition: 0, pills: [], config: { field: 'a1c_value', thresholds: [7, 9] }, patientCount: 6 },
      { id: 'da-6a', type: 'action', label: 'Continue Current Tx', description: 'A1c < 7%', columnIndex: 5, verticalPosition: 0, pills: [{ label: '< 7%' }], config: {}, patientCount: 2 },
      { id: 'da-6b', type: 'action', label: 'Adjust Medication', description: 'A1c 7-9%', columnIndex: 5, verticalPosition: 1, pills: [{ label: '7-9%', variant: 'warning' }], config: {}, patientCount: 3 },
      { id: 'da-6c', type: 'escalation', label: 'Endocrine Referral', description: 'A1c > 9%', columnIndex: 5, verticalPosition: 2, pills: [{ label: '> 9%', variant: 'warning' }, { label: '1 urgent' }], config: {}, patientCount: 1, gapCount: 1 },
      { id: 'da-7', type: 'metric', label: 'Quarterly Review', columnIndex: 6, verticalPosition: 0, pills: [{ label: '87% in range' }], config: {}, patientCount: 15 },
      { id: 'da-8', type: 'loop-reference', label: 'Repeat in 90 days', columnIndex: 6, verticalPosition: 1, pills: [], config: { targetNodeId: 'da-2' } },
    ],
    connections: [
  ...
  // --- Colon Cancer Screening Protocol (6 columns, ~12 patients) ---
  {
    id: 'proto-colon-screening',
    ...
    nodes: [
      { id: 'cs-1', type: 'cohort-source', label: 'Screening Cohort', columnIndex: 0, verticalPosition: 0, pills: [{ label: '12 pts' }], config: {}, patientCount: 12 },
      { id: 'cs-2', type: 'filter', label: 'Age Eligible', description: '45-75 years', columnIndex: 1, verticalPosition: 0, pills: [{ label: '10 eligible' }], config: { ageMin: 45, ageMax: 75 }, patientCount: 10 },
      { id: 'cs-3', type: 'branch', label: 'Screening Status', columnIndex: 2, verticalPosition: 0, pills: [], config: {}, patientCount: 10 },
      { id: 'cs-4a', type: 'action', label: 'Schedule Colonoscopy', description: 'Never screened or overdue', columnIndex: 3, verticalPosition: 0, pills: [{ label: '4 overdue', variant: 'warning' }], config: {}, patientCount: 4, gapCount: 4 },
      { id: 'cs-4b', type: 'action', label: 'FIT Test Reminder', description: 'Annual FIT alternative', columnIndex: 3, verticalPosition: 1, pills: [{ label: '3 due' }], config: {}, patientCount: 3 },
      { id: 'cs-4c', type: 'wait-monitor', label: 'Up to Date', description: 'No action needed', columnIndex: 3, verticalPosition: 2, pills: [{ label: '3 current' }], config: {}, patientCount: 3 },
      { id: 'cs-5', type: 'action', label: 'Patient Contact', description: 'Outreach for scheduling', columnIndex: 4, verticalPosition: 0, pills: [{ label: '2 contacted' }], config: {}, patientCount: 2 },
      { id: 'cs-6', type: 'metric', label: 'Screening Rate', columnIndex: 5, verticalPosition: 0, pills: [{ label: '72%' }], config: {}, patientCount: 12 },
    ],
    connections: [
  ...
  // --- Post-Discharge Follow-up Protocol (7 columns, ~8 patients) ---
  {
    id: 'proto-post-discharge',
    ...
    nodes: [
      { id: 'pd-1', type: 'cohort-source', label: 'Recent Discharges', columnIndex: 0, verticalPosition: 0, pills: [{ label: '8 pts' }], config: {}, patientCount: 8 },
      { id: 'pd-2', type: 'filter', label: 'High Readmit Risk', description: 'LACE score ≥ 10', columnIndex: 1, verticalPosition: 0, pills: [{ label: '3 high risk', variant: 'warning' }], config: { laceThreshold: 10 }, patientCount: 3 },
      { id: 'pd-3a', type: 'action', label: '48h Phone Call', description: 'Prioritized outreach', columnIndex: 2, verticalPosition: 0, pills: [{ label: '2 pending' }], config: { timeframe: '48h' }, patientCount: 2 },
      { id: 'pd-3b', type: 'action', label: '72h Phone Call', description: 'Standard outreach', columnIndex: 2, verticalPosition: 1, pills: [{ label: '3 pending' }], config: { timeframe: '72h' }, patientCount: 3 },
      { id: 'pd-4', type: 'action', label: '7-day Visit', description: 'In-person follow-up', columnIndex: 3, verticalPosition: 0, pills: [{ label: '4 scheduled' }], config: {}, patientCount: 4 },
      { id: 'pd-5', type: 'branch', label: 'Med Reconciliation', columnIndex: 4, verticalPosition: 0, pills: [], config: {}, patientCount: 4 },
      { id: 'pd-6a', type: 'action', label: 'Meds Reconciled', description: 'No discrepancies', columnIndex: 5, verticalPosition: 0, pills: [{ label: '2 done' }], config: {}, patientCount: 2 },
      { id: 'pd-6b', type: 'escalation', label: 'Med Discrepancy', description: 'Needs provider review', columnIndex: 5, verticalPosition: 1, pills: [{ label: '1 alert', variant: 'warning' }], config: {}, patientCount: 1, gapCount: 1 },
      { id: 'pd-7', type: 'metric', label: '30-day Readmission', columnIndex: 6, verticalPosition: 0, pills: [{ label: '12.5%' }], config: {}, patientCount: 8 },
    ],
    connections: [
...
export const MOCK_POP_HEALTH_PATIENTS: ProtocolPatient[] = [
  // Diabetes patients
  { patientId: 'p1', name: 'Robert Martinez', age: 58, gender: 'M', riskTier: 'high',
    protocols: [{ protocolId: 'proto-diabetes-a1c', currentNodeId: 'da-6c', stageEntryDate: d(12), status: 'escalated', history: [
  ...
  { patientId: 'p2', name: 'Susan Chen', age: 62, gender: 'F', riskTier: 'stable',
    protocols: [{ protocolId: 'proto-diabetes-a1c', currentNodeId: 'da-6a', stageEntryDate: d(20), status: 'active', history: [
  ...
  { patientId: 'p3', name: 'James Wilson', age: 55, gender: 'M', riskTier: 'rising',
    protocols: [{ protocolId: 'proto-diabetes-a1c', currentNodeId: 'da-6b', stageEntryDate: d(15), status: 'active', history: [
  ...
  { patientId: 'p4', name: 'Maria Garcia', age: 49, gender: 'F', riskTier: 'stable',
    protocols: [{ protocolId: 'proto-diabetes-a1c', currentNodeId: 'da-4', stageEntryDate: d(5), status: 'active', history: [
  ...
  { patientId: 'p5', name: 'Thomas Brown', age: 67, gender: 'M', riskTier: 'rising',
    protocols: [{ protocolId: 'proto-diabetes-a1c', currentNodeId: 'da-3', stageEntryDate: d(3), status: 'active', history: [
  ...
  { patientId: 'p6', name: 'Patricia Lee', age: 52, gender: 'F', riskTier: 'stable',
    protocols: [{ protocolId: 'proto-diabetes-a1c', currentNodeId: 'da-6a', stageEntryDate: d(30), status: 'active', history: [
  ...
  { patientId: 'p7', name: 'David Kim', age: 71, gender: 'M', riskTier: 'high',
    protocols: [{ protocolId: 'proto-diabetes-a1c', currentNodeId: 'da-6b', stageEntryDate: d(10), status: 'active', history: [
  ...
  { patientId: 'p8', name: 'Linda Johnson', age: 60, gender: 'F', riskTier: 'stable',
    protocols: [{ protocolId: 'proto-diabetes-a1c', currentNodeId: 'da-2', stageEntryDate: d(2), status: 'active', history: [] }],
  ...
  { patientId: 'p9', name: 'William Taylor', age: 45, gender: 'M', riskTier: 'high',
    protocols: [{ protocolId: 'proto-diabetes-a1c', currentNodeId: 'da-3', stageEntryDate: d(7), status: 'active', history: [] }],
  ...
  { patientId: 'p10', name: 'Jennifer White', age: 54, gender: 'F', riskTier: 'stable',
    protocols: [{ protocolId: 'proto-diabetes-a1c', currentNodeId: 'da-4', stageEntryDate: d(4), status: 'active', history: [] }],
  ...
  { patientId: 'p11', name: 'Michael Davis', age: 63, gender: 'M', riskTier: 'rising',
    protocols: [{ protocolId: 'proto-diabetes-a1c', currentNodeId: 'da-3', stageEntryDate: d(1), status: 'active', history: [] }],
  ...
  { patientId: 'p12', name: 'Elizabeth Moore', age: 56, gender: 'F', riskTier: 'stable',
    protocols: [{ protocolId: 'proto-diabetes-a1c', currentNodeId: 'da-7', stageEntryDate: d(60), status: 'active', history: [] }],
  ...
  { patientId: 'p24', name: 'Barbara Anderson', age: 52, gender: 'F', riskTier: 'stable',
    protocols: [{ protocolId: 'proto-colon-screening', currentNodeId: 'cs-4a', stageEntryDate: d(30), status: 'active', history: [
  ...
  { patientId: 'p25', name: 'Richard Thompson', age: 58, gender: 'M', riskTier: 'rising',
    protocols: [{ protocolId: 'proto-colon-screening', currentNodeId: 'cs-5', stageEntryDate: d(14), status: 'active', history: [
  ...
  { patientId: 'p26', name: 'Margaret Clark', age: 65, gender: 'F', riskTier: 'stable',
    protocols: [{ protocolId: 'proto-colon-screening', currentNodeId: 'cs-4c', stageEntryDate: d(180), status: 'active', history: [] }],
  ...
  { patientId: 'p27', name: 'Charles Wright', age: 50, gender: 'M', riskTier: 'stable',
    protocols: [{ protocolId: 'proto-colon-screening', currentNodeId: 'cs-4b', stageEntryDate: d(10), status: 'active', history: [] }],
  ...
  { patientId: 'p31', name: 'George Harris', age: 74, gender: 'M', riskTier: 'high',
    protocols: [{ protocolId: 'proto-post-discharge', currentNodeId: 'pd-3a', stageEntryDate: d(2), status: 'active', history: [
  ...
  { patientId: 'p32', name: 'Dorothy Martin', age: 68, gender: 'F', riskTier: 'high',
    protocols: [{ protocolId: 'proto-post-discharge', currentNodeId: 'pd-4', stageEntryDate: d(5), status: 'active', history: [
  ...
  { patientId: 'p33', name: 'Paul Robinson', age: 55, gender: 'M', riskTier: 'rising',
    protocols: [{ protocolId: 'proto-post-discharge', currentNodeId: 'pd-6b', stageEntryDate: d(1), status: 'escalated', history: [
  ...
  { patientId: 'p34', name: 'Helen Walker', age: 78, gender: 'F', riskTier: 'stable',
    protocols: [{ protocolId: 'proto-post-discharge', currentNodeId: 'pd-3b', stageEntryDate: d(1), status: 'active', history: [
  ...
  { patientId: 'p35', name: 'Frank Young', age: 61, gender: 'M', riskTier: 'stable',
    protocols: [{ protocolId: 'proto-post-discharge', currentNodeId: 'pd-6a', stageEntryDate: d(3), status: 'active', history: [
...
// ============================================================================
// Dashboard Metrics (pre-computed per protocol)
// ============================================================================
...
export const COHORT_METRICS: Record<string, DashboardMetric[]> = {
  'coh-diabetes': [
    ...
    { id: 'cm-d2', label: 'Active Protocols', value: 1 },
...
export const DASHBOARD_ALERTS: DashboardAlert[] = [
  ...
  },
  {
    ...
    protocolId: 'proto-post-discharge',
    nodeId: 'pd-6b',
  },
  {
    id: 'alert-3',
  ...
  },
  {
    ...
    protocolId: 'proto-colon-screening',
  },
];

// ============================================================================
// Default Filters (per protocol)
// ============================================================================

export const DEFAULT_PROTOCOL_FILTERS: Record<string, PopHealthFilter[]> = {
  'proto-diabetes-a1c': [
...
export function getProtocolById(protocolId: string): Protocol | undefined {
  return PROTOCOLS.find((p) => p.id === protocolId);
}

export function getProtocolsByCohort(cohortId: string): Protocol[] {
  return PROTOCOLS.filter((p) => p.cohortId === cohortId);
}

export function getPatientsByProtocol(protocolId: string): ProtocolPatient[] {
  return MOCK_POP_HEALTH_PATIENTS.filter((p) =>
    p.protocols.some((a) => a.protocolId === protocolId)
  );
}

export function getPatientsByNode(protocolId: string, nodeId: string): ProtocolPatient[] {
  return MOCK_POP_HEALTH_PATIENTS.filter((p) =>
    p.protocols.some((a) => a.protocolId === protocolId && a.currentNodeId === nodeId)
  );
}

export function getMetricsForProtocol(protocolId: string): DashboardMetric[] {
  return DASHBOARD_METRICS[protocolId] ?? [];
}
...
export function getAlertsForProtocol(protocolId: string): DashboardAlert[] {
  return DASHBOARD_ALERTS.filter((a) => a.protocolId === protocolId);
}
