...
export const mockProblems: ProblemItem[] = [
  ...
  },
  {
    ...
    onsetDate: '06/02/18',
    history: [
      { id: 'evt-4a', type: 'recurrence', performedBy: 'Dr. Tanaka, MD', performedAt: '02/01/26, 2:30p PT', effectiveDate: '02/01/26' },
      { id: 'evt-4f', type: 'event-edited', performedBy: 'Dr. Priya Sharma, MD', performedAt: '09/20/23, 9:15a PT', relatedEventId: 'evt-4b', changes: [{ field: 'effectiveDate', from: '09/15/23', to: '08/30/23' }] },
      { id: 'evt-4b', type: 'marked-inactive', performedBy: 'Dr. Priya Sharma, MD', performedAt: '09/15/23, 3:00p PT', effectiveDate: '08/30/23' },
      { id: 'evt-4c', type: 'marked-active', performedBy: 'Dr. Priya Sharma, MD', performedAt: '06/02/18, 11:15a PT', effectiveDate: '06/02/18' },
      { id: 'evt-4d', type: 'confirmed', performedBy: 'Dr. Priya Sharma, MD', performedAt: '06/02/18, 11:14a PT', effectiveDate: '06/02/18' },
  ...
  },
  {
    ...
    history: [
      { id: 'evt-15a', type: 'marked-resolved', performedBy: 'Dr. Priya Sharma, MD', performedAt: '11/30/25, 4:00p PT', effectiveDate: '11/30/25' },
